...
# This loop processes each VCF file and splits it by sample
# for file in *.vcf*; do 
...
bash /home/ahgillmo/master_scripts_slurm/controlFreeC_scripts/process_controlfreec_segments_for_pairtree.sh $2
...
bash /home/ahgillmo/master_scripts_slurm/pairtree_scripts/Calc_read_probability.sh $1".temp.PairTree.txt"
